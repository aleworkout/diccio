...
class DefinitionsControllerTest < ActionController::TestCase
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post :create, definition: { definition: @definition.definition, example: @definition.example, id_word: @definition.id_word }
    end
  ...
  test "should update definition" do
    patch :update, id: @definition, definition: { definition: @definition.definition, example: @definition.example, id_word: @definition.id_word }
    assert_redirected_to definition_path(assigns(:definition))
  end
